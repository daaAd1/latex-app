...
class TaylorCell extends React.PureComponent {
  ...
  componentWillReceiveProps(nextProps) {
    if (
      ...
      this.setReceivedProps(JSON.parse(nextProps.arrowPropertiesObject));
    }
  }

  setReceivedProps(arrowPropertiesObject) {
    this.setState({
      arrowPropertiesObject,
    });
  }
  ...
  handleTextChange(event) {
    this.props.onTextChange(event.target.value, this.props.row, this.props.column);
  }
